...
[vertical /* , horizontal */].forEach((axis: Axis) => {
  describe(`on ${axis.direction} axis`, () => {
    ...
    describe('moving forward from start', () => {
      ...
      // const reorderImpact: DragImpact = (() => {
      ...
      it('should remain displaced when moving forward in the first two thirds of the target', () => {
        ...
        {
          const afterTwoThirds: Position = add(
            onTwoThirdsOfInHome3,
            patch(axis.line, 1),
          );
          const impact: DragImpact = getDragImpact({
            pageBorderBoxCenter: afterTwoThirds,
            draggable: preset.inHome2,
            draggables: preset.draggables,
            droppables: withCombineEnabled,
            previousImpact: homeImpact,
      ...
      it.only('should remain displaced when moving backwards in the first two thirds of the target', () => {
