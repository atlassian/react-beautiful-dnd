...
function useTouchSensor(api) {
  ...
  var startPendingDrag = useMemoOne.useCallback(function startPendingDrag(actions, point, target) {
...
function findClosestDragHandleFromEvent$1(contextId, event) {
  var target = event.target;
...
function tryGetClosestDraggableIdFromEvent(contextId, event) {
  var handle = findClosestDragHandleFromEvent$1(contextId, event);
...
function useSensorMarshal(_ref4) {
  ...
  var findClosestDragHandle = useMemoOne.useCallback(function (event) {
  ...
  var api = useMemoOne.useMemo(function () {
    return {
      ...
      findClosestDragHandle: findClosestDragHandle,
      findOptionsForDraggable: findOptionsForDraggable,
      tryReleaseLock: tryReleaseLock,
      isLockClaimed: isLockClaimed
    };
  }, [canGetLock, tryGetLock, findClosestDraggableId, findClosestDragHandle, findOptionsForDraggable, tryReleaseLock, isLockClaimed]);
