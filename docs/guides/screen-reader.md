...
A screen reader will read out information about a [widget](https://www.w3.org/TR/accname-1.1/#dfn-widget) (a user interface object) when it is given browser focus. A widget has a number of _accessibility properties_ that are used to determine what a screen reader will announce.
