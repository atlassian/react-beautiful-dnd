...
A screen reader will read out information about a [widget](TODO) (a user interface object) when it is given browser focus. A widget has a number of _accessibility properties_ that are used to determine what a screen reader will announce.

<details>
  <summary>Background on widget accessibility properties 📖</summary>

| Attribute        | Description                                                                                                      | Notes                                                                                                                                                                                                                                                                               | Examples                                                                                                                                                   |
| ---------------- | ---------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Name             | A way of identifying the element. Ideally these would be unique. Often it is just the content of the element     | This property is computed. Can be based on visible text, or invisible attributes such as `aria-label`. The highest priority value will be picked as the name                                                                                                                        | `aria-label`, `aria-labelledby`, `title` (but not recommended) element content                                                                             |
...
| Description      | Adds additional usage information about an element                                                               | This property is [computed](https://www.w3.org/TR/accname-1.1/#mapping_additional_nd_te). Mostly controlled by `aria-describedby` ["Using the aria-describedby property to provide a descriptive label for user interface controls"](https://www.w3.org/TR/WCAG20-TECHS/ARIA1.html) |                                                                                                                                                            |
...
We will not be controlling the **name** of the element. The name is a way to identify the element and is usually the content of the element (see accessibility guide above)

| Attribute            | Code                                                      | Notes                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| -------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Role**             | `DragHandleProps` <br/> `role="button"`                   | We _need_ a _drag handle_ to be a _widget_ in order to correctly set widget accessibility properties. We choose `"button"` by default. This way, even if you make your drag handle a non-widget element such as `<div>` then it will be treated as a widget. If you are making a interactive element your _drag handle_ then you are welcome to remove this `role`                                                                                                                                                            |
