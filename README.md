...
* [Examples <g-emoji class="g-emoji" alias="tada" fallback-src="https://assets-cdn.github.com/images/icons/emoji/unicode/1f389.png">🎉</g-emoji>](#examples-)
    * [Viewing on a desktop](#viewing-on-a-desktop)
    * [Viewing on a mobile or tablet](#viewing-on-a-mobile-or-tablet)
* [Basic usage examples](#basic-usage-examples)
* [Upgrading](#upgrading)
* [Core characteristics](#core-characteristics)
* [Currently supported feature set](#currently-supported-feature-set)
    * [Lots more coming soon](#lots-more-coming-soon)
* [Not for everyone](#not-foreveryone)
* [Driving philosophy: physicality](#driving-philosophy-physicality)
    * [Application 1: no instant movement](#application-1-no-instant-movement)
    * [Application 2: knowing when to move](#application-2-knowing-when-to-move)
    * [Application 3: no drop shadows](#application-3-no-drop-shadows)
    * [Application 4: maximise interactivity](#application-4-maximise-interactivity)
    * [Application 5: no drag axis locking](#application-5-no-drag-axis-locking)
    * [Application 6: natural cross list movement](#application-6-natural-cross-list-movement)
* [Carefully designed animations](#carefully-designed-animations)
    * [Dropping](#dropping)
    * [Moving out of the way](#moving-out-of-the-way)
* [Caring about the interaction details](#caring-about-the-interaction-details)
    * [Focus management](#focus-management)
    * [Auto scrolling](#auto-scrolling)
      * [For mouse and touch inputs <g-emoji class="g-emoji" alias="mouse" fallback-src="https://assets-cdn.github.com/images/icons/emoji/unicode/1f42d.png">🐭</g-emoji><g-emoji class="g-emoji" alias="iphone" fallback-src="https://assets-cdn.github.com/images/icons/emoji/unicode/1f4f1.png">📱</g-emoji>](#for-mouse-and-touch-inputs-)
      * [For keyboard dragging <g-emoji class="g-emoji" alias="musical_keyboard" fallback-src="https://assets-cdn.github.com/images/icons/emoji/unicode/1f3b9.png">🎹</g-emoji>](#for-keyboard-dragging-)
    * [Accessibility](#accessibility)
* [Mouse dragging](#mouse-dragging)
    * [Sloppy clicks and click blocking <g-emoji class="g-emoji" alias="cat" fallback-src="https://assets-cdn.github.com/images/icons/emoji/unicode/1f431.png">🐱</g-emoji><g-emoji class="g-emoji" alias="gift" fallback-src="https://assets-cdn.github.com/images/icons/emoji/unicode/1f381.png">🎁</g-emoji>](#sloppy-clicks-and-click-blocking-)
    * [Keyboard shortcuts: mouse dragging](#keyboard-shortcuts-mouse-dragging)
* [Keyboard dragging](#keyboard-dragging)
    * [Keyboard shortcuts: keyboard dragging](#keyboard-shortcuts-keyboard-dragging)
      * [Within a vertical list](#within-a-vertical-list)
      * [Within a horizontal list](#within-a-horizontal-list)
* [Touch dragging](#touch-dragging)
    * [Understanding intention: tap, force press, scroll and drag](#understanding-intention-tap-force-press-scroll-and-drag)
    * [Starting a drag: long press](#starting-a-drag-long-press)
    * [Tap support](#tap-support)
    * [Native scrolling support](#native-scrolling-support)
    * [Force press support](#force-press-support)
    * [Vibration](#vibration)
* [Preset styles](#preset-styles)
    * [In every phase](#in-every-phase)
      * [Always: drag handle](#always-drag-handle)
      * [Always: Droppable](#always-droppable)
    * [Phase: resting](#phase-resting)
      * [(Phase: resting): drag handle](#phase-resting-drag-handle)
    * [Phase: dragging](#phase-dragging)
      * [(Phase: dragging): drag handle element](#phase-dragging-drag-handle-element)
      * [(Phase: dragging): Draggable element](#phase-dragging-draggable-element)
      * [(Phase: dragging): body element](#phase-dragging-body-element)
    * [Phase: dropping](#phase-dropping)
      * [(Phase: dropping): drag handle element](#phase-dropping-drag-handle-element)
      * [(Phase: dropping): draggable](#phase-dropping-draggable)
    * [Phase: user cancel](#phase-user-cancel)
    * [Preset styles are vendor prefixed](#preset-styles-are-vendor-prefixed)
* [Installation](#installation)
    * [Package manager](#package-manager)
    * [Distribution bundle](#distribution-bundle)
* [<a href="https://clojurescript.org/" rel="nofollow">ClojureScript</a>](#clojurescript)
* [API](#api)
* [DragDropContext](#dragdropcontext)
    ...
    * [onDragStart (optional)](#ondragstart-optional)
      * [start: DragStart](#start-dragstart)
      * [onDragStart type information](#ondragstart-type-information)
    * [onDragUpdate (optional)](#ondragupdate-optional)
      * [update: DragUpdate](#update-dragupdate)
    * [onDragEnd (required)](#ondragend-required)
      * [result: DropResult](#result-dropresult)
    * [Synchronous reordering](#synchronous-reordering)
      * [Here is what you need to do](#here-is-what-you-need-to-do)
    * [Persisting a reorder](#persisting-a-reorder)
    * [Best practices for hooks](#best-practices-for-hooks)
      * [Block updates during a drag](#block-updates-during-a-drag)
      * [Force focus after a transition between lists](#force-focus-after-a-transition-between-lists)
    * [onDragStart and <code>onDragEnd</code> pairing](#ondragstart-and-ondragend-pairing)
* [Droppable](#droppable)
    * [Droppable props](#droppable-props)
    * [Children function](#children-function)
      * [1. provided: (DroppableProvided)**](#1-provided-droppableprovided)
      * [2. snapshot: (DroppableStateSnapshot)**](#2-snapshot-droppablestatesnapshot)
    * [Conditionally dropping](#conditionally-dropping)
    * [Scroll containers](#scroll-containers)
    * [Empty Droppables](#empty-droppables)
    * [Recommended Droppable performance optimisation](#recommended-droppable-performance-optimisation)
* [Draggable](#draggable)
    * [Draggable Props](#draggable-props)
    * [Children function](#children-function-1)
      * [1. provided: (DraggableProvided)**](#1-provided-draggableprovided)
      * [2. Snapshot: (DraggableStateSnapshot)**](#2-snapshot-draggablestatesnapshot)
    * [Interactive child elements within a Draggable](#interactive-child-elements-within-a-draggable)
* [Flow usage](#flow-usage)
    * [Public flow types](#public-flow-types)
    * [Using the flow types](#using-the-flow-types)
* [Typescript](#typescript)
    * [Sample application with flow types](#sample-application-with-flow-types)
